...
void take_screenshot(GtkWidget *widget, gpointer data) {
    ...
    if (pixbuf != NULL) {
        ...
        g_print("Screenshot saved as screenshot.png\n");
    } else {
...
void activate(GtkApplication *app, gpointer user_data) {
    ...
    gtk_box_pack_start(GTK_BOX(hbox), screenshot_button, FALSE, FALSE, 0);
    g_signal_connect(screenshot_button, "clicked", G_CALLBACK(take_screenshot), window);
